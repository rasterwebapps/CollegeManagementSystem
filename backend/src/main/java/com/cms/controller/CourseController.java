...
public class CourseController {
    ...
    public ResponseEntity<List<CourseResponse>> findByProgramId(
            @PathVariable Long programId) {
        return ResponseEntity.ok(courseService.findByProgramId(programId));
    }

    @GetMapping("/by-department/{departmentId}")
    public ResponseEntity<List<CourseResponse>> findByDepartmentId(

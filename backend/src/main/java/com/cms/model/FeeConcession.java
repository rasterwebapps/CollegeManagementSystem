...
public class FeeConcession {
    ...
    @Column(name = "concession_type", nullable = false, length = 50) private String concessionType;
    ...
    public String getConcessionType() { return concessionType; } public void setConcessionType(String v) { this.concessionType = v; }
